...
Main idea:
    ...
    Until now, the concept of "audio hosting" has not had a clear embodiment and was only partially implemented in different, but essentially similar platforms.
...
Platform mechanisms:
    ...
    Podcasts and voice recordings:
        ...
        A voice recording is a short audio message attached to a comment or publication that cannot be pre-recorded.
