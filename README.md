...
Плеер имеет различные типы визуального отображения, а во время воспроизведения показыкает <ins>живые подсказки</ins> всплывающие примечания и вложения, присвоенные определенным тайм-кодам.
