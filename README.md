...
До сих пор концепция "аудиохостинг" не имела четкого воплощения и была реализована в разных, но схожих по сути платформах.
...
Посты размещаются в его профиле и могут содержать текст, вложения и аудиомедиа (подкаст/аудиозапись).
Публикацим можно оценивать, публично отвечать на них или комментировать текстом или голосом.
...
Также свою голосовую запись можно закрепить в шапке профиля в качестве *Аудиостатуса* - так можно рассказать о своих интересах, о чем вы ведете блог или просто об обновлении.
...
Слушатель в свою очередь может подписаться отдельно на каждую из лент (или разом на всего Автора), при этом количество подписчиков Автора будет складываться из числа пользователей, подписанных хотя бы на одну из его лент.

* Слушатель может объединить множество подписок в группу, создавая *Ленты просмотра* с настройкой отдельно для каждой параметров показа контента.
...
Мы не принуждаем пользователей смотреть или слушать рекламу, покупать платные подписки и не вводим особых возрастных ограничений.
