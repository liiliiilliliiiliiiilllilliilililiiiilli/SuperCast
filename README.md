...
По сей день концепция "аудиохостинг" не имела воплощения и была разрознена меджу но схожими по своей сути сервисами.
Не существовало аудиосервиса столь же универсального и практичного в своей стезе, как качественно это делает [YouTube](https://www.youtube.com), реализуя просмотр видео-роликов, [Pinterest](https://www.pinterest.com) для создания коллажей или [Telegram](https://telegram.org) для свободного общения.
Подкасты и голосовые записи не имели права на самостоятельность, существуя второстепенно и без должного развития.
Вдобавок, серия музыкальных сервисов вроде [Yandex.Music](https://music.yandex.ru) или [Spotify](https://www.spotify.com) при всей своей безальтернативности имеют ограничения, вводя пользователей в платежи за подписки, а также вторгаясь в их частное цифровое пространство (например, криптографически запрещая доступ к скаченным на устройство аудиофайлам, лишая пользователя доверия к собственному ПО).

SuperCast выступает аудиоплатформой с акцентом на свободу ПО и использования пользовательского контента.
Подкасты, голосовые записи и вложения к публикациям можно свободно скачивать, переиспольозвать и распространять - таковы правила сообщества.
Мы создаем сервис по правилам интернета, каковым он и должен быть - никто вас не ограничивает во внешних действиях и не вторгается в личные.
