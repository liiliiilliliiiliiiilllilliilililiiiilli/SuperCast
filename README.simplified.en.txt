...
Main idea:
    ...
    Until now, the concept of "audio hosting" did not have a clear embodiment and was scattered between essentially similar platforms.
    There was no audio service as original as YouTube (https://www.youtube.com) does, implementing video viewing, Pinterest (https://www.pinterest.com) for creating collages or Telegram (https://telegram.org) for free communication.
...
Service mechanisms:
    ...
    Podcasts and audio recordings:
        ...
        They can be listened to and simultaneously watch a live transcript of the conversation.
        The player has several types of visual display, and during playback, Live hints assigned to certain time codes pop up in the form of notes and attachments.
        ...
        An audio recording is a short voice message for an attachment to a comment or publication that cannot be pre-recorded.
        Any audio recording can be transcribed into text.
        One audio recording can also be pinned to the profile as a Voice status.

    Search engine:

        It may seem like a simple function, but we have built in search with filters literally everywhere - it is available on any screen and helps to search for users, publications, comments or interesting moments in audio media.

    Thematic feeds and subscriptions:

        For clarity, the Author can thematically distribute publications in their profile into different Publication Feeds, giving them a name and description.
        ...
        The listener can combine multiple subscriptions into separate View Feeds, setting up content display parameters for each separately.
    ...
    Storage and download:
        ...
        Storage is a tree of folders and files of downloads on the current device and virtually saved content, accessible between several devices. Saved content can be grouped at your discretion, and the system will automatically divide it by type.
...
Distribution and use:
    ...
    The service is in development - an application for Android is being prepared.
    Later, a website, an application for iOS and desktops for Linux, Windows and MacOS will be released.
    ...
    The project has an open code base, but currently does not assume third-party edits.

And also:

    The experience with Facebook (https://facebook.com), VK (https://vk.com), Twitter (https://x.com) and other revolutionary "junk" shows that social networks take on too much responsibility for people's lives and experiences.
    ...
    It is unusual to hear such things from the creators of another social network - isn't it?

    That is why we challenge all other services, defending the ideology of user freedom, and want to set an example that a free Internet is something to strive for.
